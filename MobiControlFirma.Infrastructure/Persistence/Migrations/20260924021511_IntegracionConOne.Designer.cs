...
namespace MobiControlFirma.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260924021511_IntegracionConOne")]
    partial class IntegracionConOne
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MobiControlFirma.Domain.Entities.Empresa", b =>
                {
                    ...
                    b.Property<string>("OneApiKey")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("OneApiSecret")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("OneSlug")
                        .IsRequired()
                        .HasMaxLength(120)
                        .HasColumnType("nvarchar(120)");

                    b.Property<Guid>("OneTenantId")
                    ...
                    b.HasIndex("OneTenantId")
                        .IsUnique()
                        .HasDatabaseName("UQ_Empresas_OneTenantId");
